...
- `read_only` (Boolean) Whether the Application Key is read-only. Read-only keys have limited permissions and cannot perform write operations. Cannot be changed after creation.
