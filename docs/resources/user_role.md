...
- `workspace_id` (String) ID of a workspace that the role has access to. The billing grant type can only be associated with the empty workspace ID '-' and vice-versa.
