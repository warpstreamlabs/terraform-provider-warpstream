		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet("warpstream_workspace.test", "application_key.id"),
					resource.TestCheckResourceAttrSet("warpstream_workspace.test", "application_key.name"),
					resource.TestCheckResourceAttrSet("warpstream_workspace.test", "application_key.key"),
					resource.TestCheckResourceAttrSet("warpstream_workspace.test", "application_key.created_at"),
				),
			},
		},
	})
